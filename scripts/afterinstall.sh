...
sudo mv /home/ec2-user/wordpress/*.yml /home/ec2-user/test/
sudo mv /home/ec2-user/wordpress/scripts /home/ec2-user/test/
sudo mv /home/ec2-user/wordpress/nginx.co* /etc/nginx/
